...
const WORK: Entry[] = [
  {
    ...
    bullets: [
      ...
      "Built server-side RBAC for the customer portal — token-based authentication, an explicit roles × resources policy matrix, and row-level ownership enforcement across the portal's data domains.",
